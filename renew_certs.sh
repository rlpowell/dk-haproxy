...
CAROOT="/home/spdkhaproxy/dk-haproxy/misc/realm_certs/ca_root/" TRUST_STORES='none' mkcert -cert-file '/home/spdkhaproxy/dk-haproxy/misc/realm_certs/star.realm.pem' -key-file '/home/spdkhaproxy/dk-haproxy/misc/realm_certs/star.realm.key' -p12-file misc/realm_certs/star.realm.p12 hassio.realm plex.realm vaultwarden.realm pihole.realm pi-hole.realm hassio.r3alm waffles.realm waffles.r3alm hashbrowns.realm hashbrowns.r3alm lemonade.realm lemonade.r3alm plex.r3alm vaultwarden.r3alm pihole.r3alm pi-hole.r3alm unifi.realm unifi.r3alm 192.168.123.127
